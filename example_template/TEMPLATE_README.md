...
* newspaper.jpg (The image to be analyzed)
* prompt.txt (The prompt used by the AI)
* template.json (The json template with the questions and blank fields for the respective image)
