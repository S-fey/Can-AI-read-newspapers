#!/usr/bin/env python3
"""
Ask Claude to answer newspaper front-page questions from an image.
...
Usage:
    python analyze_newspaper_claude.py newspaper.jpg
    python analyze_newspaper_claude.py newspaper.jpg --prompt prompt.txt --template template.json --output answer.json
"""
...
def ask_task(client: Anthropic, base_instructions: str, media_type: str, image_b64: str, task_items: list) -> dict:
...
def main():
    ...
    media_type, image_b64 = encode_image(Path(args.image))
    ...
    for i, task_items in enumerate(tasks, start=1):
        ...
        try:
            answers = ask_task(client, base_instructions, media_type, image_b64, task_items)
